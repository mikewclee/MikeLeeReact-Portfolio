    ...
    return (
        <div className="about">
            <div className="row aboutMeCaption">
                ...
                <h3> I grew up in NYC and currently live in Brooklyn. I studied engineering in college and graduated
                with a Masters from NYU. In my spare time, I enjoy basketball, fitness, cooking, traveling, spirits,
                    and playing poker.</h3>
                    <a href="mailto:mikewclee@gmail.com" target="_top">Email</a>
                    <a href="https://github.com/mikewclee" target="_blank"> Github</a>
                    <a href="https://www.linkedin.com/in/mikewlee" target="_blank">Linked</a>
